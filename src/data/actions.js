let actions = {
  2: {msg:"Du kommst wegen langer Warteschlangen vor dem WC nicht rechtzeitig in deinen Startblock. 1x Aussetzen",action:1},
  ...
  17: {msg:"Deine Freunde sitzen in der Kramgasse beim Apéro, um dich anzufeuern. Du aber brauchst einen Schluck. 1x Aussetzen",action:1},
  ...
  52: {msg:"Piriformis-Alarm in der grünen Hölle! Der hinterhältige Ehrgeiz-Muskel im Gesäss meldet sich schmerzhaft. Du musst dein Tempo zügeln. 1x aussetzen.",action:1},
  ...
  79: {msg:"Diese kleine, fiese Steigung hattest du nicht auf der Rechnung. What a f***! Du musst ein paar Schritte gehen. 1x Aussetzen.",action:1},
  82: {msg:"Der grösste Spalier deiner Karriere, aber deine Beine hart wie Bambus. Du gibst alles, um locker ins Publikum zu winken. Ein Hoch auf deine schauspielerische Leistung. Noch einmal würfeln",action:2},
